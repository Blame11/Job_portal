...
module.exports.getResumeFile = async (req, res, next) => {
    try {
        ...
        // Verify that the user is either the applicant or the recruiter
        ...
        if (!isApplicant && !isRecruiter) {
            return next(createError(403, "Unauthorized to view this resume"));
        }
        ...
        const filePath = require("path").join(__dirname, "../public", application.resume);
